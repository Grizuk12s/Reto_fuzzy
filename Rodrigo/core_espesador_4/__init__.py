...
- estados_builder         : helpers declarativos para pertenencias, tendencias y reglas
- estados_espesador       : catalogo reutilizable de estados y subestados
