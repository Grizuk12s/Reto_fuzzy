...
MODULOS = {
    ...
    "aceleraciones": {
        "label": "Aceleraciones",
        "hint": "aceleraciones.json — ventana, umbral de ESTABLE",
        "grupo": "Pipeline",
    },
    "estados": {
        "label": "Estados",
...
_MODULO_A_RUTA: dict[str, str] = {
    ...
    "aceleraciones": ACELERACIONES_JSON,
...
_DICT_PREVIEW = (
    "filtros", "fuzzy", "pendientes", "aceleraciones", "estados", "tracking",
    "permisivos", "defuzzy",
)
...
def _leer_modulo(clave: str):
    ...
    if clave == "aceleraciones":
        return copy.deepcopy(_leer_json(ACELERACIONES_JSON, {}))
    if clave == "estados":
