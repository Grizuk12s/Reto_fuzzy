> # ⚠️ DOCUMENTO DESACTUALIZADO — NO SEGUIR
>
> Describe el **prototipo** del espesador (tags `RETO.*`, 28 reglas hardcodeadas).
> El producto cambió: la configuración vive en `config/espesador/*.json` y se edita
> desde la web.
>
> **Documentación vigente:**
> - `PUESTA_EN_MARCHA.md` — guía operativa + estado de puesta en marcha
