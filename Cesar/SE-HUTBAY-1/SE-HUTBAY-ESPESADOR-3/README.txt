================================================================================
  !! DOCUMENTO DESACTUALIZADO -- NO SEGUIR !!

  Describe el PROTOTIPO del espesador (tags RETO.*, 28 reglas hardcodeadas).
  El producto cambio: la configuracion vive en config/espesador/*.json y se
  edita desde la web.
  ...
  Sigue siendo valido de este archivo: solo la parte de infraestructura
