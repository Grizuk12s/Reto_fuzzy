...
ACCIONES_DISPONIBLES = [
    "DISMINUIR_TONELAJE_MUY_FUERTE",
    "DISMINUIR_TONELAJE_FUERTE",
    "DISMINUIR_TONELAJE",
    "DISMINUIR_TONELAJE_SUAVE",
    "AUMENTAR_TONELAJE_MUY_FUERTE",
    "AUMENTAR_TONELAJE_FUERTE",
    "AUMENTAR_TONELAJE",
    "AUMENTAR_TONELAJE_SUAVE",
    "DISMINUIR_AGUA_MOLINO_FUERTE",
    "DISMINUIR_AGUA_MOLINO",
    "AUMENTAR_AGUA_MOLINO_FUERTE",
    "AUMENTAR_AGUA_MOLINO",
    "DISMINUIR_AGUA_CAJON_FUERTE",
    "DISMINUIR_AGUA_CAJON",
    "DISMINUIR_AGUA_CAJON_SUAVE",
    "AUMENTAR_AGUA_CAJON",
    "DISMINUIR_RPM_BOMBA",
    "AUMENTAR_RPM_BOMBA",
]
